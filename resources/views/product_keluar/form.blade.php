                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select" id="type_diskon" name="type_diskon">
                                <option value="Persentasi (%)">Persentase (%)</option>
                                <option value="Fix (IDR)">Fix Diskon</option>
                            </select>
                            <span class="help-block with-errors"></span>
                        </div>
                        <div class="form-group">
                            <label >Diskon</label>
                            <input type="number" id="diskon" class="form-control" value="0" name="diskon">
                            <span class="help-block with-errors"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="pembayaran" class="form-control" value="0" name="pembayaran">
                            <span class="help-block with-errors"></span>
                        </div>
                        <div class="form-group">
                            <label >Status</label>
